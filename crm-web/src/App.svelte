...
<Tailwindcss/>
<div
  class="bg-blue-800 fixed left-0 right-0 top-0 h-16 mt-0 z-10 flex items-center justify-between">
  <div class="flex items-center">
    <i class="material-icons text-white ml-6 cursor-pointer ripple"
...
<div class="mb-5 mt-16 px-32">
  <NavigationDrawer bind:visible={visible} marginTop="mt-16">
    <div class="w-56 bg-red-100 h-full">
      ...
      <ul class="">
        <li class="px-4 py-3 hover:bg-gray-200 text-gray-800 text-sm tracking-wide">Stock
          Analysis
        </li>
        <li class="px-4 py-3 hover:bg-gray-200 text-gray-800 text-sm tracking-wide">
          Subscriptions
        </li>
      </ul>
    </div>
